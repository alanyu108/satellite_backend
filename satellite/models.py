...
class Satellite(models.Model):
    ...
    object_status = models.CharField(max_length=32, default="Operational")
    launch_date =  models.CharField(max_length=10, default="0000-00-00")
    launch_site =  models.CharField(max_length=128, default="")
